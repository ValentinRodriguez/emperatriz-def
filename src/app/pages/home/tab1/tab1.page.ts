...
export class Tab1Page implements OnInit{
    ...
    constructor( 
               ...
               private woocommerceSrv: WoocommerceService,
    ...
    cargaPagina(event?: any) {
        this.woocommerceSrv.wooProductsHome().subscribe((resp: any) =>{
            console.log(resp);
            
            if (resp.ok) {
                this.banners = resp.data.banners;
                this.categorias = resp.data.categorias;
                this.recienLlegados = resp.data.recienLlegados;
                this.ofertas = resp.data.ofertas;
            }     
